package com.fei.feiojbackendquestionservice.controller;

import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;

import com.fei.feiojbackendcommon.annotation.AuthCheck;
import com.fei.feiojbackendcommon.common.BaseResponse;
import com.fei.feiojbackendcommon.common.DeleteRequest;
...
import com.fei.feiojbackendmodel.model.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<String> getAnswerById(long id, HttpServletRequest request) {
        ...
        if (question == null || StrUtil.isBlank(answer)) {
            throw new BusinessException(ErrorCode.NOT_FOUND_ERROR);
        }
    ...
    //public BaseResponse<String> gatQuestionAnswer()
